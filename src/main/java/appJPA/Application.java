...
public class Application {
	...
	public static void main(String[] args) {
        AbstractApplicationContext context = new ClassPathXmlApplicationContext(new String[] {"beans2.xml"});    
	...
	private void run() {
		userService.addUser(new User2("kamil", "password".toCharArray(), "kamil", "kamil@gmail.com"));
	...
	private void addUser() {
		...
		try {
			...
			// "kamil@gmail.com"));
			userService.addUser(new User2(username, password.toCharArray(), name, email));
	...
	private void getUser() {
		System.out.print("Nazwa użytkownika: ");
		String username = s.nextLine();
		User2 user = userService.getUser(username);
		if (user == null)
